...
<param name="movie" value="http://www.youtube.com/v/%(id)s"></param>
<param name="allowFullScreen" value="true"></param>
<embed src="http://www.youtube.com/v/%(id)s" type="application/x-shockwave-flash" allowfullscreen="true" width="425" height="344"></embed>
</object>
"""
...
def youtube(url):
    ...
    return YOUTUBE_EMBED % {'id': video_id}
